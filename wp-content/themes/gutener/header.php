...
<div id="page" class="site">
	...
	<?php if( get_theme_mod( 'header_layout', 'header_one' ) == '' || get_theme_mod( 'header_layout', 'header_one' ) == 'header_one' ){ ?>
		<header id="masthead" class="site-header header-one">
			<?php
				...
				if( ( get_theme_mod( 'social_media_links' ) && !get_theme_mod( 'disable_header_social_links', false ) ) || ( !get_theme_mod( 'disable_contact_detail', false ) && ( !empty(get_theme_mod( 'contact_phone', '' ) ) || !empty(get_theme_mod( 'contact_email', '' ) ) || !empty(get_theme_mod( 'contact_address', '' ) ) ) ) ){ ?>
			...
			<?php 
			if( has_nav_menu( 'menu-1') || !get_theme_mod( 'disable_search_icon', true ) || !get_theme_mod( 'disable_hamburger_menu_icon', false ) ){ ?>
	...
	<?php if( get_theme_mod( 'header_layout' ) == 'header_two' ){ ?>
		<header id="masthead" class="site-header header-two">
			<?php
				$social_icons = get_theme_mod( 'social_media_links' );
				if( ( get_theme_mod( 'social_media_links' ) && !get_theme_mod( 'disable_header_social_links', false ) ) || ( !get_theme_mod( 'disable_contact_detail', false ) && ( !empty(get_theme_mod( 'contact_phone', '' ) ) || !empty(get_theme_mod( 'contact_email', '' ) ) || !empty(get_theme_mod( 'contact_address', '' ) ) ) ) || !get_theme_mod( 'disable_search_icon', false ) || !get_theme_mod( 'disable_hamburger_menu_icon', true ) ){ ?>
					<div class="top-header">
						<div class="container">
							<div class="row align-items-center">
								<div class="col-lg-8">
